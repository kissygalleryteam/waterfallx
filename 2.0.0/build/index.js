...
kg/waterfallx/2.0.0/base
kg/waterfallx/2.0.0/loader
kg/waterfallx/2.0.0/index
...
;
KISSY.add('kg/waterfallx/2.0.0/base',function (S, Node, D) {
    var $ = Node.all,
//        D = S.DOM,
 ...
 * */
;
KISSY.add('kg/waterfallx/2.0.0/loader',function (S, Node, Waterfall) {
...
;
KISSY.add('kg/waterfallx/2.0.0/index',function (S, WaterfallX, Loader) {
